...
- [RustChain](https://rustchain.org) - Proof-of-Antiquity blockchain with native AI agent economy. Agents interact via MCP server, earn RTC tokens through x402 payment primitives, and operate on vintage hardware with 6-point hardware fingerprinting verification. ([source](https://github.com/Scottcjn/rustchain))
